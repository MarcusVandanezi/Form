...
function modalValid() {
  ...
  modalText.innerHTML = "Formulário enviado!";
  modalDiv.style.backgroundColor = "rgba(0, 0, 0, 0.4)";
  modalP.style.margin = "15% auto";
  modalP.style.backgroundColor = "green";
  modalButton.innerHTML = "Responder novamente";
}

function modalInvalid() {
  modalDiv.style.display = "block";
  modalText.innerHTML = "Dados incorretos!";
  modalP.style.backgroundColor = "red";
  modalP.style.margin = "auto";
  modalButton.innerHTML = "Fechar";
}
